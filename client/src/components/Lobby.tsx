        ...
        <div className="backdrop-blur-glass rounded-3xl shadow-2xl p-10 max-w-lg w-full animate-scale-in relative z-10">
          ...
          <div className="space-y-4 flex flex-col items-center">
            <button
              ...
              className="max-w-md w-full text-white font-bold py-16 px-8 rounded-xl transition-all text-xl shadow-lg hover:shadow-2xl transform hover:scale-105 hover:-translate-y-1 duration-200"
